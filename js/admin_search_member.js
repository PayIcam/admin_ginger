...
function checkPopover () {
  jQuery(function($){
    $('#membersList a[rel="popover"]').each(function(){
...
function refreshMemberList() {
  showLoader();
  checkXhr('memberId');
  xhr['memberId'] = jQuery.ajax({
    type : "POST",
    url : "admin_result_members.php",
...
(function($){
  ...
  **/
  ...
  $("#export").click(function(event){
    ...
    document.location.href="export_liste_members.php?"+searchForm.serialize();
    return false;
  });

...
INSERT INTO `payicam_ginger`.`applications` (`app_id`, `app_url`, `app_key`, `app_name`, `app_desc`, `app_creator`, `app_lastuse`, `app_created`, `app_removed`) VALUES (4, 'https://payicam.icam.fr/spring_festival', 'gkGSY9PvBEJqDyi2', 'Spring Festival', 'Spring Festival', DEFAULT, '2017-03-30 00:00:00', '2017-03-30 00:00:00', NULL);
